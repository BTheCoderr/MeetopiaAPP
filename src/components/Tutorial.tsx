...
const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    description: 'Send messages in real-time! The chat appears on the left side during calls. Click "Chat ×" to hide/show it.',
    position: { x: 20, y: 70 },
    icon: '💬'
  },
  {
  ...
  },
  {
    ...
    description: 'Press SPACEBAR for quick "next person" • Move mouse to show controls • Drag your video window • Chat can be hidden • Everything auto-hides for immersion!',
    position: { x: 50, y: 50 },
    icon: '⚡'
  },
  {
